...
- (void) getDataFromJSON{
    ...
    for (int i=0; i<[displayedObjects1 count]; i++) {
        ...
        NSString *strLatitude1 = [[displayedObjects1 objectAtIndex:i] objectForKey:@"latitude"];
        NSLog(@"---strLatitude1--,%@",strLatitude1);
        
        NSString *strLongitude1 = [[displayedObjects1 objectAtIndex:i] objectForKey:@"longitude"];
        NSLog(@"---strLongitude1--,%@",strLongitude1);
